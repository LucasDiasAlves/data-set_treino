...
mkdir -p "$BASE_DIR/dags" "$BASE_DIR/logs" "$BASE_DIR/plugins" "$BASE_DIR/postgresql_data" "$BASE_DIR/dados_brutos"

# Ajustando permissões dos diretórios de forma idempotente
echo "Ajustando permissões dos diretórios..."
chown -R 50000:50000 "$BASE_DIR/dags" "$BASE_DIR/logs" "$BASE_DIR/plugins" "$BASE_DIR/postgresql_data" "$BASE_DIR/dados_brutos"
chmod -R 755 "$BASE_DIR/dags" "$BASE_DIR/plugins"
chmod -R 770 "$BASE_DIR/logs" "$BASE_DIR/postgresql_data" "$BASE_DIR/dados_brutos"
